...
public class SelectCakeFood extends AppCompatActivity {
    ...
    private EditText dessert_search;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       /* dessert_search = (EditText) findViewById(R.id.dessert_search);
        dessert_search.addTextChangedListener(new TextWatcher() {
            @Override
    ...
    public void clickToReportFromCalDessert(View view) {
        Intent toReportFromCalDessert = new Intent(this, ReportActivity.class);
        startActivity(toReportFromCalDessert);
        finish();
    }

    public void backMainMenuFromDessert(View view) {
        Intent backMainMenuFromDessert = new Intent(this, MainActivity.class);
        startActivity(backMainMenuFromDessert);
        finish();
    }
    ...
    private void myAlertDialog(final String strFood, final String strFactor) {
        ...
        objBuilder.setIcon(R.drawable.cake);
        ...
        objBuilder.setPositiveButton("เพิ่ม", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                try {
                    ...
                    if (intAmount <=0) {
                        Toast.makeText(SelectCakeFood.this, "กรุณาระบุจำนวนที่มากกว่า 0", Toast.LENGTH_SHORT).show();
                    } else {
