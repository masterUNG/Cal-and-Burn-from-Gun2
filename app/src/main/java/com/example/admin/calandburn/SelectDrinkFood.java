...
public class SelectDrinkFood extends AppCompatActivity {
    ...
    public void clickToReportFromCalDrink(View view) {
        Intent toReportFromCalDrink = new Intent(this, ReportActivity.class);
        startActivity(toReportFromCalDrink);
        finish();
    }
    ...
    private void myAlertDialog(final String strFood, final String strFactor) {
        ...
        objBuilder.setIcon(R.drawable.drink);
        ...
        objBuilder.setPositiveButton("เพิ่ม", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                try {
                    ...
                    if (intAmount <=0) {
                        Toast.makeText(SelectDrinkFood.this, "กรุณาระบุจำนวนที่มากกว่า 0", Toast.LENGTH_SHORT).show();
                    } else {
