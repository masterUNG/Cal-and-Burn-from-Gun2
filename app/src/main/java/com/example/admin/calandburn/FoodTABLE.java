...
public class FoodTABLE {
    ...
    public String[] readAllDataFood(int intColumn) {
        ...
        Cursor objCursor = readSQLite.rawQuery("SELECT * FROM foodTABLE WHERE aboutfood='1' ORDER BY namefood"
                , null);
        if (objCursor != null) {
    ...
    public String[] readAllDataDessert (int intColumn) {
        ...
        String[] strResult = null;
        Cursor objCursor = readSQLite.rawQuery("SELECT * FROM foodTABLE WHERE aboutfood='2' ORDER BY namefood"
                , null);
        if (objCursor != null) {
    ...
    public String[] readAllDataDrink(int intColumn) {
        ...
        String[] strResult = null;
        Cursor objCursor = readSQLite.rawQuery("SELECT * FROM foodTABLE WHERE aboutfood='3' ORDER BY namefood"
                , null);
        if (objCursor != null) {
