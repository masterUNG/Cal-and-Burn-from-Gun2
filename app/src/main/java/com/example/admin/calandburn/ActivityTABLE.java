...
public class ActivityTABLE {
    ...
    public String[] readAllDataActivity(int intColumn) {
        ...
        Cursor objCursor = readSQLite.rawQuery("SELECT * FROM activityTABLE WHERE aboutact='2' ORDER BY nameact"
                , null);
    ...
    public String[] readAllDataExercise(int intColumn) {

        String[] strResult = null;
        Cursor objCursor = readSQLite.rawQuery("SELECT * FROM activityTABLE WHERE aboutact='1' ORDER BY nameact"
                , null);
